...
$slug = isset($_GET['slug']) ? $_GET['slug'] : die('No post specified');
...
<head>
    <meta charset="utf-8">
    <title>PYXIASINC - <?php echo htmlspecialchars($blog->title); ?></title>
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="position-relative">
                    <img class="img-fluid w-100" src="<?php echo htmlspecialchars($blog->featured_image); ?>" alt="<?php echo htmlspecialchars($blog->title); ?>">
                ...
                <div class="pt-4 pb-2">
                    <div class="d-flex mb-3">
                        <div class="d-flex align-items-center">
                            ...
                            <a class="text-muted ml-2" href=""><?php echo htmlspecialchars($blog->author); ?></a>
                        </div>
                        <div class="d-flex align-items-center ml-4">
                            <i class="far fa-bookmark text-primary"></i>
                            <a class="text-muted ml-2" href=""><?php echo htmlspecialchars($blog->status); ?></a>
                        </div>
                    </div>
                    <h2 class="font-weight-bold"><?php echo htmlspecialchars($blog->title); ?></h2>
                </div>
